...
import puntajesRouter from './routes/puntajes.js';
import obtenerEstadisticas from './routes/IAestadisticas.js';
...
app.use('/api/crearPuntajes', puntajesRouter)
app.use('/api/obtenerEstadisticas', obtenerEstadisticas);
